...
{
    [JsonPropertyName("traditionalKnowledgeLabel")]
    public List<RAiDTraditionalKnowledgeLabel>? TraditionalKnowledgeLabel { get; set; }

    [JsonPropertyName("metadata")] public RAiDMetadata? Metadata { get; set; }

    [JsonPropertyName("identifier")] public required RAiDId Identifier { get; set; }
